...
HD_PWD='C:/College Mega Sync/450/CCED/CCED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uartWencode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uartWencode.tcl -notrace
