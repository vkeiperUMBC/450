...
#set_property -dict { PACKAGE_PIN R12 IOSTANDARD LVCMOS33 } [get_ports { UART_RXD_OUT[0] }]; # Custom add - Max
#set_property -dict { PACKAGE_PIN P13 IOSTANDARD LVCMOS33 } [get_ports { UART_RXD_OUT[1] }]; # Custom add - Max
#set_property -dict { PACKAGE_PIN T11 IOSTANDARD LVCMOS33 } [get_ports { UART_RXD_OUT[2] }]; # Custom add - Max
#set_property -dict { PACKAGE_PIN V14 IOSTANDARD LVCMOS33 } [get_ports { UART_RXD_OUT[3] }]; # Custom add - Max
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { UART_TXD_IN }]; #IO_L24N_T3_A00_D16_14 Sch=uart_txd_in
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { UART_TXD_IN[0] }]; #IO_L24N_T3_A00_D16_14 # Custom add - Max
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { UART_TXD_IN[1] }]; #IO_L23N_T3_D18_14 # Custom add - Max
#set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { UART_TXD_IN[2] }]; #IO_25_14 # Custom add - Max
#set_property -dict { PACKAGE_PIN P13   IOSTANDARD LVCMOS33 } [get_ports { UART_TXD_IN[3] }]; #IO_L19P_T3_D26_14 # Custom add - Max
...
#et_property INTERNAL_VREF 0.675 [get_iobanks 34]


#t_property BITSTREAM.GENERAL.COMPRESS TRUE [current_design]